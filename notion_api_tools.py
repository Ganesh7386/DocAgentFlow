...
def append_toggle_with_bullets_for_change_log(addingToggleItemInfo: dict):
    """
    ...
    """
    print("TOGGLE INFO")
    print(addingToggleItemInfo)
    print("&&&&&&&&&*******************&&&&&&&&&&&")
    NOTION_PAGE_ID = addingToggleItemInfo.get("NOTION_PAGE_ID")
    toggle_item_text = addingToggleItemInfo.get("toggle_item_text") 
    bullet_points_list = addingToggleItemInfo.get("bullet_points_list")
...
def add_page_to_meetings_history_database_table(adding_page_info , DATABASE_ID=""):
    DATABASE_ID = "197e35223beb80039714f0cd468bce2e"
